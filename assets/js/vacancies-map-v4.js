/* =============================================================================
   THE DONROE DOCTRINE — Vacancies Map v4
   v4: fitBounds() fits BOTH width and height at once, using whichever
   ...
   sides. That's why v3 reduced the padding but didn't remove it. Same
   fix applied to the main Doctrine Map (assets/js/map-v9.js).
   ...
   fills it, and let the poles (irrelevant to this dataset) crop off the
   top and bottom on short containers.
   ...
   Also reuses the hard-won fixes from the main map's history:
     ...
     - This file has its own version suffix so editing it doesn't collide
       ...
       changes materially later, bump the suffix again (v5, v6, ...).
   ========================================================================== */
